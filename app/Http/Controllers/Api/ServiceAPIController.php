...
use App\Criteria\ServiceCriteria;
...
class ServiceAPIController extends AppBaseController
{
     ...
     *      @SWG\Parameter(
     *          name="parent_id",
     *          description="Get services with value = 0, or pass specific id to list that service's sub services.",
     *          type="integer",
     *          required=true,
     *          default=0,
     *          in="query"
    ...
    public function index(Request $request)
    {
        ...
        $this->serviceRepository->pushCriteria(new ServiceCriteria($request));
    ...
    public function show($id, Request $request)
    {
        ...
        if (empty($service)) {
            return $this->sendErrorWithData('Service not found');
        }
